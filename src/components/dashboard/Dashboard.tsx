...
export default function Dashboard() {
  ...
  return (
    <div className="">
      <div className="w-[100%] p-[20px] bg-[#4E9A77] relative">
        <Header handleLogout={handleLogout} user={user} />
        <div className="h-[20px]"></div>
        <p className="text-white text-[14px]">
        {hour >= 12 ? (hour >= 17 ? "Good evening" : "Good afternoon") : "Good morning"}
          <span className="font-[800]"> {user.holder.firstName}</span>
          <br />
          {currentDate}
          <div className="flex items-center gap-[10px] mt-[10px]">
            <div className="p-[5px_20px] rounded-full bg-white text-[#4E9A77] text-[12px]">
              +
            </div>
            <Link
              className="p-[5px_20px] rounded-full bg-white text-[#4E9A77] text-[12px]"
      ...
      <div className="p-[20px]">
        ...
        <div className="w-full rounded-[5px] overflow-hidden border border-[#4E9A77]">
          <div className="p-[10px_20px] bg-[#4E9A77] text-white text-[14px]">
            Bank accounts(1)
          </div>
          <div className="p-[10px_20px]">
            <p className="text-[12px]">CHASE CHECKING ACCOUNT</p>
            <div className="flex justify-end">
              <div className="text-green-600 font-[400] text-[20px] flex flex-col items-end">
